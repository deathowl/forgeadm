...
class ForgeService:
    def __init__(self):
        ...
        self.systemd1 = self.sysbus.get_object(
            "org.freedesktop.systemd1", "/org/freedesktop/systemd1"
        )
        self.manager = dbus.Interface(self.systemd1, "org.freedesktop.systemd1.Manager")
        self.service = self.sysbus.get_object(
            "org.freedesktop.systemd1",
            object_path=self.manager.GetUnit("minecraft.service"),
        )
        self.interface = dbus.Interface(
            self.service, dbus_interface="org.freedesktop.DBus.Properties"
        )
